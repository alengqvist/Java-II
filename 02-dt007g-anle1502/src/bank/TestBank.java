...
public class TestBank {
	...
	// ASSIGNMENT 1.
		...
		System.out.println("TEST 1 - Create a Customer:");
			Customer c1 = new Customer("Janne", "Jansson", "092103-4455", "Gatan 1", "11122", "Orten", "janne@jansson.se", CustomerType.Private);
			Customer c2 = new Customer("Kalle", "Andersson", "061223-4455", "Gatan 1", "11122", "Orten", "kalle@karlsson.se", CustomerType.Private);
			bank.addCustomer(c1);
			bank.addCustomer(c2);
