...
public class TestBank {
	...
	// ASSIGNMENT 2.
		...
		try {
			...
			Customer c3 = new Customer("David", "Eriksson", "071103-4455", "Gatan 1", "11122", "Orten", "janne@jansson.se", CustomerType.Private);
			Customer c4 = new Customer("Bertil", "Eriksson", "142223-4455", "Gatan 1", "11122", "Orten", "kalle@karlsson.se", CustomerType.Private);
			Customer c5 = new Customer("Bertil", "Bertilsson", "102213-4455", "Gatan 1", "11122", "Orten", "kalle@karlsson.se", CustomerType.Private);
			bank.addCustomer(c3);
			bank.addCustomer(c4);
			bank.addCustomer(c5);
	...
	// ASSIGNMENT 3.
		...
		try {
			...
			System.out.println("( 071103-4455) Šr ett giltigt personnummer.");
		} catch (CivicRegistrationNumberException e) {
			System.out.println(" " + e.getMessage());
		} catch (PostalCodeException e) {
			System.out.println(" " + e.getMessage());
		...
		try {
			...
			System.out.println(" (880908-2954) Šr ett giltigt personnummer.");
		} catch (CivicRegistrationNumberException e) {
			System.out.println(" " + e.getMessage());
		}  catch (PostalCodeException e) {
			System.out.println(" " + e.getMessage());
		...
		try {
			...
			System.out.println("(880908) Šr ett giltigt personnummer.");
		} catch (CivicRegistrationNumberException e) {
			System.out.println(" " + e.getMessage());
		} catch (PostalCodeException e) {
			System.out.println(" " + e.getMessage());
		...
		try {
			...
			System.out.println(" (123456) Šr ett giltigt postnummer.");
		} catch (CivicRegistrationNumberException e) {
			System.out.println(" " + e.getMessage());
		} catch (PostalCodeException e) {
			System.out.println(" " + e.getMessage());
		...
		try {
			...
			System.out.println(" (1234A) Šr ett giltigt postnummer.");
		} catch (CivicRegistrationNumberException e) {
			System.out.println(" " + e.getMessage());
		} catch (PostalCodeException e) {
			System.out.println(" " + e.getMessage());
		...
		try {
			...
			System.out.println(" (12345) Šr ett giltigt postnummer.");
		} catch (CivicRegistrationNumberException e) {
			System.out.println(" " + e.getMessage());
		} catch (PostalCodeException e) {
			System.out.println(" " + e.getMessage());
