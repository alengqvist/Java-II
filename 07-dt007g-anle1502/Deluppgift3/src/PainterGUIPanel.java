 ...
 */
public class PainterGUIPanel extends JPanel implements ActionListener, CoordinateListener {
...
//		SwingUtilities.invokeLater(() -> new PainterGUIPanel().setVisible(true));
//	}
	
	/**
	 * Constructor which builds the GUI.
	 */
	public PainterGUIPanel() {
		super();
//		// Setup JFrame.
//		setTitle("Ritprogram");
